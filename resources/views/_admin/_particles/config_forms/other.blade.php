...
<div class="tab-pane" id="post-setting">
    ...
    <hr>
    <div class="form-group">
        <label class="control-label">{{ __('Show Meta on Post page?') }}</label>
        {!! Form::select('ShowPostMeta', ['yes' => trans('admin.yes'), 'no' => trans('admin.no')],
        get_buzzy_config('ShowPostMeta', 'yes'), ['class' => 'form-control', 'data-dependecy' => 'ShowPostMeta']) !!}
    </div>
    <div class="form-group" data-target="ShowPostMeta" data-value="yes">
        <label class="control-label">{{ __('Show Author Avatar on Post page?') }}</label>
        {!! Form::select('ShowAuthorAvatar', ['yes' => trans('admin.yes'), 'no' => trans('admin.no')],
        get_buzzy_config('ShowAuthorAvatar', 'yes'), ['class' => 'form-control']) !!}
    </div>
    <div class="form-group" data-target="ShowPostMeta" data-value="yes">
        <label class="control-label">{{ __('Show Author Name on Post page?') }}</label>
        {!! Form::select('ShowAuthor', ['yes' => trans('admin.yes'), 'no' => trans('admin.no')],
        get_buzzy_config('ShowAuthor', 'yes'), ['class' => 'form-control']) !!}
    </div>
    <div class="form-group" data-target="ShowPostMeta" data-value="yes">
