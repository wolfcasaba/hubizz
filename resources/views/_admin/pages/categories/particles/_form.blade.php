        ...
        @else
            <ul class="nav nav-tabs pull-right">
                <li class="pull-left header"><i class="fa fa-edit"></i>
                    <b>{{ trans('admin.edit') }} : {{ $category->name }}</b>
                </li>
            </ul>
        @endif
        <div class="tab-content">
            <!-- Font Awesome Icons -->
            <div class="tab-pane @if (isset($category->id)) @if ($category->parent_id == null) active @endif
@else
active @endif"
                id="fa-icons">
                <!-- form start -->
                {!! Form::open(['action' => ['Admin\CategoriesController@addnew'], 'method' => 'POST']) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('name', isset($category->name) ? $category->name : null, [
                            ...
                            'placeholder' => trans('admin.Entercategoryname'),
                        ]) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('name_slug', trans('admin.CategorySlug')) !!}
                        {!! Form::text('name_slug', isset($category->name_slug) ? $category->name_slug : null, [
                            'id' => 'name_slug',
                            'class' => 'form-control input-lg',
                            'placeholder' => trans('admin.Entercategoryslug'),
                        ]) !!}
                    </div>
                    <div class="form-group">
                        ...
                        {!! Form::text('posturl_slug', isset($category->posturl_slug) ? $category->posturl_slug : null, [
                            'id' => 'posturl_slug',
                            'class' => 'form-control input-lg',
                            'placeholder' => trans('admin.Enterpoststitleslug'),
                        ]) !!}
                    ...
                    @if (isset($category->id))
                        <div class="form-group">
                            ...
                            {!! Form::select(
                                'disabled',
                                ['0' => trans('admin.no'), '1' => trans('admin.yes')],
                                isset($category->disabled) ? $category->disabled : null,
                                ['class' => 'form-control'],
                            ) !!}
                        </div>
                    @endif
                    @if (get_multilanguage_enabled())
                        <div class="form-group">
                            ...
                            {!! Form::select(
                                ...
                                !empty($category->language) ? $category->language : get_buzzy_locale(),
                                [
                                    'id' => 'changeLanguage',
