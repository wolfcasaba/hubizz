<div class="sidebar visiblesidebar-onmobile">
    <div class="sidebar--fixed">
        <div class="question-post-side-bar-form">
            ...
            <div class="cd-form">
                <legend>{{ __('Post Meta Title') }}</legend>
                    {!! Form::text('meta_title', isset($post->meta_title) ? $post->meta_title : null,
                    ['class' => 'cd-input', 'id' => 'meta_title', 'placeholder' => __('Add custom meta title')]) !!}
            </div>
            <div class="cd-form">
                <legend>{{ __('Post Meta Description') }}</legend>
                    {!! Form::text('meta_description', isset($post->meta_description) ? $post->meta_description : null,
                    ['class' => 'cd-input', 'id' => 'meta_description', 'placeholder' => __('Add custom meta description')]) !!}
            </div>
            @endif
            <div class="cd-form">
