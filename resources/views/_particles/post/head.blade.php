@section('head_title', $post->meta_title ? $post->meta_title : str_replace('"', '', $post->title). ' | '.get_buzzy_config('sitename'))
@section('og_type', 'article')
@section('head_description', $post->meta_description ? $post->meta_description : str_limit(str_replace('"', '', $post->body), 150))
