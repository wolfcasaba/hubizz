...
class DashboardController extends MainAdminController
{
    public function index()
    {
        ...
        $todaypost = Post::whereDate('created_at', '>=', $rangetoday)->byLanguage()->count();

        $todayusers = User::whereDate('created_at', '>=', $rangetoday)->count();

        $todaylogins = User::whereDate('updated_at', '>=', $rangetoday)->count();
